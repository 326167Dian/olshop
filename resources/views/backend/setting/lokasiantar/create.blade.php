...
@section('title', 'Tambah Lokasi Antar')

@section('header', 'Form Tambah Lokasi Antar')
    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Form Tambah Lokasi Antar</h3>
            </div>

            <form action="{{ route('lokasi-antar.store') }}" method="POST">
                @csrf
                <div class="card-body">
