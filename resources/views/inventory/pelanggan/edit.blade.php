...
@section('content')
    <div class="card card-primary">
        ...
        <form action="{{ route('inventory.pelanggan.update', $pelanggan->id_pelanggan) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <select name="jenis_kelamin" id="jenis_kelamin"
                            ...
                            <option value="PRIA" {{ old('jenis_kelamin', $pelanggan->jenis_kelamin) == 'PRIA' ? 'selected' : '' }}>PRIA</option>
                            <option value="WANITA" {{ old('jenis_kelamin', $pelanggan->jenis_kelamin) == 'WANITA' ? 'selected' : '' }}>WANITA</option>
                        </select>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" name="tlp_pelanggan" id="tlp_pelanggan"
                            ...
                            value="{{ old('tlp_pelanggan', $pelanggan->tlp_pelanggan) }}">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <textarea name="alamat_pelanggan" id="alamat_pelanggan" rows="3"
                            class="form-control @error('alamat_pelanggan') is-invalid @enderror">{{ old('alamat_pelanggan', $pelanggan->alamat_pelanggan) }}</textarea>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <textarea name="ket_pelanggan" id="ket_pelanggan" rows="3"
                            class="form-control @error('ket_pelanggan') is-invalid @enderror">{{ old('ket_pelanggan', $pelanggan->ket_pelanggan) }}</textarea>
