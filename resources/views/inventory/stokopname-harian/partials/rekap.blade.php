<table id="tabel-rekap-so-harian" class="table table-bordered table-striped">
    <thead>
        <tr>
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="{{ $isPemilik ? 9 : 8 }}" class="text-center">Belum ada data stok opname untuk shift &amp; tanggal ini.</td>
            </tr>
        @endforelse
    </tbody>
</table>
<script>
    $(function () {
        $('#tabel-rekap-so-harian').DataTable({
