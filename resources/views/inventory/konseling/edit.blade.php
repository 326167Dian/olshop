...
@section('header', 'Ubah Konseling')

@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Ubah Konseling</h3>
        </div>
        <form action="{{ route('inventory.konseling.update', $konseling->id_konseling) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <select name="id_pelanggan" id="id_pelanggan"
                            ...
                            @foreach ($pelangganList as $p)
                                <option value="{{ $p->id_pelanggan }}" {{ old('id_pelanggan', $konseling->id_pelanggan) == $p->id_pelanggan ? 'selected' : '' }}>
                                    {{ $p->nm_pelanggan }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="date" name="tgl_konseling" id="tgl_konseling"
                            ...
                            value="{{ old('tgl_konseling', \Carbon\Carbon::parse($konseling->tgl_konseling)->format('Y-m-d')) }}">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="text" name="nama_dokter" id="nama_dokter"
                            ...
                            value="{{ old('nama_dokter', $konseling->nama_dokter) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="diagnosa" id="diagnosa" rows="2"
                        class="form-control @error('diagnosa') is-invalid @enderror">{{ old('diagnosa', $konseling->diagnosa) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="riwayat_penyakit" id="riwayat_penyakit" rows="2"
                        class="form-control @error('riwayat_penyakit') is-invalid @enderror">{{ old('riwayat_penyakit', $konseling->riwayat_penyakit) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="riwayat_alergi" id="riwayat_alergi" rows="2"
                        class="form-control @error('riwayat_alergi') is-invalid @enderror">{{ old('riwayat_alergi', $konseling->riwayat_alergi) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="keluhan" id="keluhan" rows="2"
                        class="form-control @error('keluhan') is-invalid @enderror">{{ old('keluhan', $konseling->keluhan) }}</textarea>
                ...
                <div class="col-md-6 form-group p-0">
                    ...
                    <input type="text" name="visite" id="visite"
                        class="form-control @error('visite') is-invalid @enderror"
                        value="{{ old('visite', $konseling->visite) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="tindakan" id="tindakan" rows="2"
                        class="form-control @error('tindakan') is-invalid @enderror">{{ old('tindakan', $konseling->tindakan) }}</textarea>
