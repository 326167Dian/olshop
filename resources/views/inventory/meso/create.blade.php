...
@section('header', 'Formulir Pelaporan ESO')

@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Formulir Pelaporan Efek Samping Obat (ESO)</h3>
        </div>
        <form action="{{ route('inventory.meso.store') }}" method="POST">
            @csrf
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="kode_sumber_data" id="kode_sumber_data" class="form-control"
                        style="max-width: 300px;" value="{{ old('kode_sumber_data') }}">
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" name="nama_singkat" class="form-control"
                            value="{{ old('nama_singkat', $pelanggan->nm_pelanggan ?? '') }}" readonly>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <select name="status_hamil" id="status_hamil" class="form-control">
                            ...
                            <option value="hamil" {{ old('status_hamil') == 'hamil' ? 'selected' : '' }}>Hamil</option>
                            <option value="tidak_hamil" {{ old('status_hamil') == 'tidak_hamil' ? 'selected' : '' }}>Tidak Hamil</option>
                            <option value="tidak_tahu" {{ old('status_hamil') == 'tidak_tahu' ? 'selected' : '' }}>Tidak Tahu</option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-2 form-group">
                        ...
                        <input type="text" name="berat_badan" id="berat_badan" class="form-control" value="{{ old('berat_badan') }}">
                    </div>
                    <div class="col-md-4 form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="penyakit_utama" id="penyakit_utama" rows="3"
                        class="form-control @error('penyakit_utama') is-invalid @enderror">{{ old('penyakit_utama') }}</textarea>
                    @error('penyakit_utama') <span class="invalid-feedback">{{ $message }}</span> @enderror
                </div>
                <div class="form-group">
                    <label>Kondisi Lain yang Menyertai</label><br>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="gangguan_ginjal" id="gangguan_ginjal" value="1">
                        <label class="form-check-label" for="gangguan_ginjal">Gangguan Ginjal</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="gangguan_hati" id="gangguan_hati" value="1">
                        <label class="form-check-label" for="gangguan_hati">Gangguan Hati</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="alergi" id="alergi" value="1">
                        <label class="form-check-label" for="alergi">Alergi</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="kondisi_medis_lain" id="kondisi_medis_lain" value="1">
                    ...
                    <input type="text" name="kondisi_medis_lain_ket" class="form-control mt-2"
                        placeholder="Sebutkan kondisi medis lainnya" value="{{ old('kondisi_medis_lain_ket') }}">
                </div>
                <div class="form-group">
                    ...
                    @foreach (['sembuh' => 'Sembuh', 'sembuh_gejala_sisa' => 'Sembuh dengan gejala sisa', 'belum_sembuh' => 'Belum sembuh', 'meninggal' => 'Meninggal', 'tidak_tahu' => 'Tidak Tahu'] as $val => $label)
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="kesudahan_penyakit" id="kp_{{ $val }}" value="{{ $val }}" {{ old('kesudahan_penyakit') == $val ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <textarea name="manifestasi_eso" id="manifestasi_eso" rows="3"
                        class="form-control @error('manifestasi_eso') is-invalid @enderror">{{ old('manifestasi_eso') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="masalah_mutu_produk" id="masalah_mutu_produk" rows="2" class="form-control">{{ old('masalah_mutu_produk') }}</textarea>
                </div>
                <div class="col-md-4 form-group p-0">
                    ...
                    <input type="date" name="tanggal_mula_eso" id="tanggal_mula_eso"
                        class="form-control @error('tanggal_mula_eso') is-invalid @enderror" value="{{ old('tanggal_mula_eso') }}">
                ...
                <div class="form-group">
                    ...
                    @foreach (['sembuh' => 'Sembuh', 'sembuh_gejala_sisa' => 'Sembuh dengan gejala sisa', 'belum_sembuh' => 'Belum sembuh', 'meninggal' => 'Meninggal', 'tidak_tahu' => 'Tidak Tahu'] as $val => $label)
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="kesudahan_eso" id="ke_{{ $val }}" value="{{ $val }}" {{ old('kesudahan_eso') == $val ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <textarea name="riwayat_eso" id="riwayat_eso" rows="2" class="form-control">{{ old('riwayat_eso') }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="keterangan_tambahan" id="keterangan_tambahan" rows="3" class="form-control"
                        placeholder="Contoh: kecepatan timbulnya ESO, reaksi setelah obat dihentikan, dsb">{{ old('keterangan_tambahan') }}</textarea>
                </div>
                <div class="form-group">
                    <label for="data_laboratorium">Data Laboratorium</label>
                    <textarea name="data_laboratorium" id="data_laboratorium" rows="2" class="form-control">{{ old('data_laboratorium') }}</textarea>
                </div>
                <div class="col-md-3 form-group p-0">
                    <label for="tanggal_pemeriksaan_lab">Tanggal Pemeriksaan Lab</label>
                    <input type="date" name="tanggal_pemeriksaan_lab" id="tanggal_pemeriksaan_lab" class="form-control" value="{{ old('tanggal_pemeriksaan_lab') }}">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" name="nama_pelapor" id="nama_pelapor"
                            ...
                            value="{{ old('nama_pelapor', auth('admin')->user()->nama_lengkap) }}">
