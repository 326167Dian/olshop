...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">JURNAL HARI INI</h3>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="tabel-jurnal" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Tanggal</th>
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center">Belum ada jurnal hari ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                    <tfoot>
            ...
            @if ($isPemilik)
                <div class="text-center">
                    <span style="font-size:6vh; background-color:#00fafa;">SALDO Rp. {{ number_format($saldo, 0, ',', '.') }}</span>
                    <br>
                    <a class="btn btn-success btn-flat" href="{{ route('inventory.jurnalkas.excel') }}" target="_blank">EXPORT TO EXCEL</a>
                </div>
            @endif
        </div>
    </div>
