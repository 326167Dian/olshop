...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            <a class="btn btn-sm btn-secondary mb-3" href="{{ route('inventory.trbmasukpbf.evaluasi.index') }}">Kembali</a>
                        ...
                        @forelse ($rows as $index => $row)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($row->status_label === 'Diterima')
                                        <span class="badge bg-success">Diterima</span>
                                    @elseif ($row->status_label === 'Dibatalkan')
