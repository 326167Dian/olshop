...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Evaluasi Barang Masuk PBF</h3>
        </div>
        <div class="card-body">
            <a class="btn btn-sm btn-secondary mb-3" href="{{ route('inventory.trbmasukpbf.index') }}">Kembali</a>

            <div class="table-responsive">
                <table id="tabel-evaluasi-pbf" class="table table-auto table-sm table-bordered table-striped w-100">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Petugas</th>
...
<script>
    $(function() {
        $('#tabel-evaluasi-pbf').DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            autoWidth: false,
            ajax: "{{ route('inventory.trbmasukpbf.evaluasi.data') }}",
            order: [[0, 'desc']],
            columns: [
